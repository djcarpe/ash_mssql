defmodule AshMssql.MigrationGenerator.Operation do
  @moduledoc false
  ...
  defmodule AddAttribute do
    ...
    def down(
      ...
      AshMssql.MigrationGenerator.Operation.RemoveAttribute.up(%{
        op
        | attribute: attribute,
          table: table,
          multitenancy: multitenancy
  ...
  defmodule AlterAttribute do
    ...
    def up(%{
      ...
      type_or_reference =
        if AshMssql.MigrationGenerator.has_reference?(multitenancy, attribute) and
  ...
  defmodule RemoveAttribute do
    ...
    def down(%{attribute: attribute, multitenancy: multitenancy, commented?: true}) do
      ...
      contents =
        %AshMssql.MigrationGenerator.Operation.AddAttribute{
          attribute: attribute,
          multitenancy: multitenancy
        }
        |> AshMssql.MigrationGenerator.Operation.AddAttribute.up()
        |> String.split("\n")
        |> Enum.map_join("\n", &"# #{&1}")
  ...
  defmodule AddCustomIndex do
    ...
    def down(%{index: index, table: table, multitenancy: multitenancy}) do
      index_name = AshMssql.CustomIndex.name(table, index)
