defmodule Mix.Tasks.AshMssql.Migrate do
  use Mix.Task
  ...
  ## Examples
      ...
      mix ash_mssql.migrate --domains MyApp.Domain1,MyApp.Domain2

      mix ash_mssql.migrate -n 3
      mix ash_mssql.migrate --step 3

      mix ash_mssql.migrate --to 20080906120000
