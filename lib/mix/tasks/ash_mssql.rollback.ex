defmodule Mix.Tasks.AshMssql.Rollback do
  use Mix.Task

  import AshMssql.Mix.Helpers,
  ...
  ## Examples
      ...
      mix ash_mssql.rollback -r Custom.Repo
      mix ash_mssql.rollback -n 3
      mix ash_mssql.rollback --step 3
      mix ash_mssql.rollback -v 20080906120000
      mix ash_mssql.rollback --to 20080906120000
  ...
  def run(args) do
    ...
    repos = AshMssql.Mix.Helpers.repos!(opts, args)
    ...
    rest_opts =
      args
      |> AshMssql.Mix.Helpers.delete_arg("--domains")
      |> AshMssql.Mix.Helpers.delete_arg("--migrations-path")
