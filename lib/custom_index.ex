defmodule AshMssql.CustomIndex do
  ...
  @schema [
    ...
    include: [
      type: {:list, :string},
      doc:
        "specify fields for a covering index. This is not supported by all databases. For more information on MSSQL support, please read the official docs."
    ]
  ]
