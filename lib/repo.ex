defmodule AshMssql.Repo do
  @moduledoc """
  Resources that use `AshMssql.DataLayer` use a `Repo` to access the database.
  ...
  configuration to the `AshMssql.Repo` implementation.
  """
  ...
  @doc """
  Use this to inform the data layer about the oldest potential mssql version it will be run on.
