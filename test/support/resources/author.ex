defmodule AshMssql.Test.Author do
  @moduledoc false
  use Ash.Resource,
  ...
  attributes do
    ...
    attribute(:bio, AshMssql.Test.Bio, public?: true)
  ...
  relationships do
    has_one(:profile, AshMssql.Test.Profile, public?: true)
    has_many(:posts, AshMssql.Test.Post, public?: true)
  end
  ...
  calculations do
    ...
    calculate :param_full_name,
              :string,
              {AshMssql.Test.Concat, keys: [:first_name, :last_name]} do
