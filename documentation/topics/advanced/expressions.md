...
In addition to the expressions listed in the [Ash expressions guide](https://hexdocs.pm/ash/expressions.html), AshMssql provides the following expressions

# Fragments

Fragments allow you to use arbitrary mssql expressions in your queries. Fragments can often be an escape hatch to allow you to do things that don't have something officially supported with Ash.
